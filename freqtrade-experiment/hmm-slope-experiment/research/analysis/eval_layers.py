...
This is the experiment adapter around the reusable readers in
`evaluation-framework/evaluation/backtest.py`.
"""
...
from evaluation.backtest import load_daily_returns, load_trade_returns, load_wallet_curve
