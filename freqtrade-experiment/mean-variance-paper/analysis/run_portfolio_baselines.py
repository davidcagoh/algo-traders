...
Writes:
  analysis/results/portfolio_baselines_hl_1h_current.json
  analysis/results/portfolio_baselines_hl_1h_current.md
"""
...
UNIVERSE_JSON = REPO / "analysis" / "results" / "universe_selection_hl_1h_current.json"
