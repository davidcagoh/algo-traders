...
**Strategy:** `strategies/FundingExtremeMR.py`
**Code:** F1
...
- Thesis: counter-funding mean-reversion (long when funding extremely negative — overshoot snap-back). Pre-registered kill criteria in `2026-05-16-decision-008-kill-criteria-funding-mr.md`.
