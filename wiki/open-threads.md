...
- **[RESOLVED 2026-08-06]** The uncommitted `evaluation-framework/` and `literature/strategy-evaluation/` changes flagged earlier today as unexplained were this session's own work: Phase 7 (SPA/Reality Check, `evaluation/spa.py`) — see `decisions-archive.md` 2026-08-06.
