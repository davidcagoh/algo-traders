...
**Strategy file:** `strategies/<file>.py`
...
Generate with: `./.venv/bin/python analysis/eval_layers.py <zip_path>`
...
One concrete follow-up experiment. If the answer is "nothing — this direction is dead," add a `Ruled Out` entry in `../learnings.md` with the mechanism.

---

## Leaderboard update

Add / update the row in `../_index.md` Strategy Leaderboard.
