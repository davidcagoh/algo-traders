...
Writes a comparison table to stdout and analysis/results/mean_variance_hl_universe.json.
"""
...
RESEARCH = REPO.parent / "hmm-slope-experiment" / "research"
FT = RESEARCH / ".venv" / "bin" / "freqtrade"
CONFIG = REPO / "configs" / "config_hl_mv_universe.json"
STRATEGY = "MeanVariancePortfolio"
TIMEFRAME = "1h"
TIMERANGE = "20251110-20260601"
FEE_TAKER = 0.00035
RESULT_JSON = REPO / "analysis" / "results" / "mean_variance_hl_universe.json"
