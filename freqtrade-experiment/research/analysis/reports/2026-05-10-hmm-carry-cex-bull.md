...
**Strategy file:** `strategies/HmmCarry.py` (unchanged; reads Binance funding via `CARRY_FUNDING_EXCHANGE=binance`)
...
Result archive: `analysis/backtests/hmm_carry_binance_bull_2023_2025.zip`
