...
kurtosis 5--340 typical of trend strategies with fat right tails. We apply
...
returns with sample skew up to $+21$ and excess kurtosis up to $+470$), DSR
...
is the term that bites at our scale --- with kurtosis 5--340 our raw Sharpe
...
ranges from 5 to 340 across our strategies; the kurtosis correction shrinks
...
repository under
\texttt{backtesting/wiki/results/2026-05-*.md}. Each card contains: trade
...
\texttt{backtesting/wiki/decisions/00N-kill-criteria-<strategy>.md}
