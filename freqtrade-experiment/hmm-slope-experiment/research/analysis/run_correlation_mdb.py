...
Writes:
  analysis/reports/correlation_matrix.png   — heatmap (Pearson)
  analysis/reports/_correlation_table.json — corr matrix + MDB table
...
ZIP_DIR = REPO / "analysis" / "backtests"
...
def main() -> None:
    ...
    out_png = REPO / "analysis" / "reports" / "correlation_matrix.png"
    ...
    out_json = REPO / "analysis" / "reports" / "_correlation_table.json"
    payload = {
        "common_window": {
