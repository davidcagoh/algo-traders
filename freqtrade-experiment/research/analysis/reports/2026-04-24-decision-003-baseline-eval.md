...
- Already verified end-to-end on 2026-04-24: 5001 rows of 1h BTC/USDC:USDC data land in `data/hyperliquid/`, `freqtrade backtesting` consumes them, 49 trades over ~200 days, placeholder `LongOnlyStrategy` lost 0.89%.
...
2. Update the expected baseline values cited in `../_index.md` Strategy Leaderboard.
3. Update the canonical baseline command in `README.md` if the baseline changes.
