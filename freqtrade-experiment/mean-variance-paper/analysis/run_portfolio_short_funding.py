...
Writes:
  analysis/results/portfolio_short_funding_hl_1h_current.json
  analysis/results/portfolio_short_funding_hl_1h_current.md
"""
...
FUNDING_DIR = REPO.parent / "hmm-slope-experiment" / "research" / "data" / "hyperliquid" / "funding"
