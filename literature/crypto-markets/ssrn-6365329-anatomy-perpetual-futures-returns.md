...
**Date:** March 7, 2026
**Access status:** Record only — automated SSRN PDF retrieval failed.
...
**Actionable idea 3 — Liquidity as carry risk filter.** Spread and depth predictors suggest high-spread / shallow-book environments predict lower carry returns. Actionable as a filter: if Hyperliquid L2 book shows wide spread → reduce carry size (the liquidity-filter question formerly tracked in the shared wiki).
