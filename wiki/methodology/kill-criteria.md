...
Every new strategy that graduates from research to evaluation gets a kill-criteria decision doc *before* its first backtest. From `backtesting/CLAUDE.md`:

> *"Pre-registration discipline (locked by decision 005): every new strategy gets a `wiki/decisions/00N-kill-criteria-<strategy>.md` before its first backtest. Non-negotiable."*

Lift this as a cross-project methodology rule:

- **Backtesting subproject:** decision docs live at `backtesting/wiki/decisions/00N-kill-criteria-<strategy>.md`.
- **Feishu subproject:** decision docs live at `feishu/wiki/decisions/00N-kill-criteria-<strategy>.md` (same filename pattern, mirrored).
...
- [`004-kill-criteria-sma-regime-180.md`](../../backtesting/wiki/decisions/004-kill-criteria-sma-regime-180.md) — T3 (SmaRegime180), the template for the four canonical axes plus continuous shrinkage.
- [`006-kill-criteria-pairs.md`](../../backtesting/wiki/decisions/006-kill-criteria-pairs.md) — pairs / cointegration-conditional family.
- [`007-kill-criteria-cross-sectional.md`](../../backtesting/wiki/decisions/007-kill-criteria-cross-sectional.md) — cross-sectional momentum.
- [`008-kill-criteria-funding-mr.md`](../../backtesting/wiki/decisions/008-kill-criteria-funding-mr.md) — funding-rate mean-reversion.
...
Worked examples in the backtesting subproject ([`006`](../../backtesting/wiki/decisions/006-kill-criteria-pairs.md), [`007`](../../backtesting/wiki/decisions/007-kill-criteria-cross-sectional.md), [`008`](../../backtesting/wiki/decisions/008-kill-criteria-funding-mr.md)). The same template applies to feishu: an A-share pairs strategy would still monitor cointegration p-value; an A-share factor-rotation strategy would still monitor factor-return dispersion.
...
Worked example from T3 ([`004-kill-criteria-sma-regime-180.md`](../../backtesting/wiki/decisions/004-kill-criteria-sma-regime-180.md)):
...
- Backtesting decision docs [`004`](../../backtesting/wiki/decisions/004-kill-criteria-sma-regime-180.md), [`006`](../../backtesting/wiki/decisions/006-kill-criteria-pairs.md), [`007`](../../backtesting/wiki/decisions/007-kill-criteria-cross-sectional.md), [`008`](../../backtesting/wiki/decisions/008-kill-criteria-funding-mr.md) — concrete worked examples of the four canonical axes + family axis + continuous shrinkage.
