...
| Tag | Meaning |
|---|---|
| ★ | Paper-trade candidate (passed cross-cycle validation under decision 004) |
...
Do *not* duplicate per-run findings here — those live in `analysis/reports/<date>-<strategy>.md`. This doc is the family-level map; findings live one level down.
