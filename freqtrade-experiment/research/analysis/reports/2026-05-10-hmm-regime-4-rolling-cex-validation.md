...
**Strategy:** `strategies/HmmRegime4Rolling.py` (rolling-window refit, no look-ahead)
...
4. **Update leaderboard image.** `analysis/reports/leaderboard.png` should now show HMM with cross-cycle data, not just Hyperliquid.
