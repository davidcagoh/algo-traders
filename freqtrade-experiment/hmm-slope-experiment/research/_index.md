...
**Current state:** The original {T3, R∧T2} candidate book is parked after the `HmmSmaSlopeV2` paper run failed its live gate. See [`EXPERIMENT.md`](../EXPERIMENT.md).
...
**Sibling project:** later mean-variance and PC-neutral work belongs to the
collaborator-owned [`../../mean-variance-paper/`](../../mean-variance-paper/), including
its strategy, config, analysis, results, agent instructions, and paper monitors.
...
- `analysis/` — experiment-specific evaluation drivers.
...
- [`../../mean-variance-paper/`](../../mean-variance-paper/) — complete collaborator-owned mean-variance project.
- Crypto-market paper notes live in [`literature/crypto-markets/`](../../../literature/crypto-markets/); search automation lives in the root `quant-research-agent/` project and its log in root `literature/`.
...
|-------|-------|------|--------------------|------|
| Crypto Carry | Management Science 2026 / BIS WP 1087 | 2026 | P1 — CEX carry degradation (Sharpe 6.45 → negative in 2025); regime change confirms DEX-only strategy direction and why conditional entry is mandatory | [bis-wp1087-crypto-carry.md](../../../literature/crypto-markets/bis-wp1087-crypto-carry.md) |
| Order Flow and Cryptocurrency Returns | Journal of Financial Markets (online first Jan 2026) | Jan 2026 | P4 — Daily FX-adjusted OFI → cross-sectional crypto returns; Sharpe 3.63 OOS; sets daily lower-bound for H14 1h question; X2 OFI-ranking variant | [ssrn-5020002-order-flow-crypto-returns.md](../../../literature/crypto-markets/ssrn-5020002-order-flow-crypto-returns.md) |
| Return and Volatility Forecasting Using On-Chain Flows in Cryptocurrency Markets | arXiv 2411.06327 | Nov 2024 | P4 — Hourly USDT exchange inflow → BTC 1h returns (strongest horizon); stablecoin inflow channel confirmed; OHLCV NBV proxy is a distinct mechanism | [2411.06327-on-chain-flow-forecasting.md](../../../literature/crypto-markets/2411.06327-on-chain-flow-forecasting.md) |
| Temporal Dynamics of Market Microstructure in Cryptocurrency Perpetual Futures | MDPI JRFM 14(5):103 | Apr 2026 | P1+H6 — CEX→DEX Granger causality confirmed hourly; intraday spread peaks 4h post-settlement | [10.3390-ijfs14050103-temporal-perpetual-microstructure.md](../../../literature/crypto-markets/10.3390-ijfs14050103-temporal-perpetual-microstructure.md) |
| Systematic Trend-Following with Adaptive Portfolio Construction | arXiv 2602.11708 | Feb 2026 | P2 — Calmar 3.18 / Sharpe 2.41 on 6h crypto with volatility-regime trailing stop; 6h aligns with funding cycle | [2602.11708-adaptive-crypto-trend-following.md](../../../literature/crypto-markets/2602.11708-adaptive-crypto-trend-following.md) |
| Microstructure Alpha: Hierarchical Learning and Cross-Asset Transfer in Cryptocurrency Markets | Frontiers in Blockchain | May 2026 | P4 — Minute-level OFI killed by fees; spot→futures transfer valid same-asset; 1h aggregation the open question | [10.3389-fbloc.2026.1811716-microstructure-alpha.md](../../../literature/crypto-markets/10.3389-fbloc.2026.1811716-microstructure-alpha.md) |
| Anatomy of Cryptocurrency Perpetual Futures Returns | SSRN 6365329 | Mar 2026 | P1 — 63/170 perp-return predictors significant; log basis strongest carry gate | [ssrn-6365329-anatomy-perpetual-futures-returns.md](../../../literature/crypto-markets/ssrn-6365329-anatomy-perpetual-futures-returns.md) |
| A Novel Approach to Trading Strategy Parameter Optimization Using Double Out-of-Sample and Walk-Forward Techniques | arXiv 2602.10785 | Feb 2026 | P2 — Walk-forward refit cadence: long training + long testing beats frequent refit on crypto 1h | [2602.10785-double-oos-walk-forward.md](../../../literature/crypto-markets/2602.10785-double-oos-walk-forward.md) |
| Explainable Patterns in Cryptocurrency Microstructure | arXiv 2602.00776 | Jan 2026 | P4 — OFI monotone with concavity at extremes in Binance Futures perps; VWAP-to-mid asymmetric mean-reversion | [2602.00776-explainable-crypto-microstructure.md](../../../literature/crypto-markets/2602.00776-explainable-crypto-microstructure.md) |
| Funding-Aware Optimal Market Making for Perpetual DEXs | arXiv 2605.06405 | May 2026 | P1 — Carry window duration (OU half-life ~8h on Hyperliquid ETH/BTC/SOL) | [2605.06405-funding-aware-market-making.md](../../../literature/crypto-markets/2605.06405-funding-aware-market-making.md) |
| Slippage-at-Risk (SaR): A Forward-Looking Liquidity Risk Framework for Perpetual Futures Exchanges | arXiv 2603.09164 | Mar 2026 | P3 — Slippage on Hyperliquid (real order-book data) | [2603.09164-slippage-at-risk.md](../../../literature/crypto-markets/2603.09164-slippage-at-risk.md) |
| Evaluating Structured Strategy Backtests: Peer Benchmarks, Regime Timing, and Live Performance | arXiv 2604.18821 | Apr 2026 | P3 — Backtest-vs-live divergence | [2604.18821-backtest-regime-live-performance.md](../../../literature/crypto-markets/2604.18821-backtest-regime-live-performance.md) |
| Markov and HMM for Regime Detection in Cryptocurrency Markets: Evidence from Bitcoin (2024–2026) | Preprints.org 202603.0831 | Mar 2026 | P2 — Regime detection (crypto-specific HMM) | [preprints-2026030831-crypto-hmm-regimes.md](../../../literature/crypto-markets/preprints-2026030831-crypto-hmm-regimes.md) |
| Explainable Regime Aware Investing | arXiv 2603.04441 | Mar 2026 | P2 — Regime detection | [2603.04441-explainable-regime-aware-investing.md](../../../literature/crypto-markets/2603.04441-explainable-regime-aware-investing.md) |
| Who Sets the Range? Funding Mechanics and 4h Context in Crypto Markets | arXiv 2601.06084 | Dec 2025 | P1+P2+P4 — Carry timing + HMM covariate + mean-reversion trigger | [2601.06084-funding-mechanics-4h-context.md](../../../literature/crypto-markets/2601.06084-funding-mechanics-4h-context.md) |
| The Two-Tiered Structure of Cryptocurrency Funding Rate Markets | MDPI Mathematics 14(2):346 | Jan 2026 | P1+P3 — Funding rate carry + execution costs | [10.3390-math14020346-two-tiered-funding-rate-markets.md](../../../literature/crypto-markets/10.3390-math14020346-two-tiered-funding-rate-markets.md) |
| Trends and Reversion in Financial Markets on Time Scales from Minutes to Decades | arXiv 2501.16772 | Jan 2025 | P4 — Mean-reversion boundary at 1h–4h | [2501.16772-trends-and-reversion-timescales.md](../../../literature/crypto-markets/2501.16772-trends-and-reversion-timescales.md) |
| Exploring Risk and Return Profiles of Funding Rate Arbitrage on CEX and DEX | Blockchain: Research and Applications (Elsevier) | Aug 2025 | P1 — DEX carry return profile | [s2096720925000818-cex-dex-funding-arbitrage.md](../../../literature/crypto-markets/s2096720925000818-cex-dex-funding-arbitrage.md) |
| Predictability of Funding Rates | SSRN 5576424 | Oct 2025 | P1 — Funding rate carry signal | [ssrn-5576424-funding-rate-predictability.md](../../../literature/crypto-markets/ssrn-5576424-funding-rate-predictability.md) |
...
| Path | Role |
|------|------|
| `configs/` | Backtest configurations; no private keys committed. |
| `strategies/` | Freqtrade strategies from the HMM/slope experiment. |
...
| `analysis/` | HMM/slope evaluation and reporting drivers. |
| `analysis/reports/` | Dated decisions, result cards, JSON tables, and generated charts. |
| `../../mean-variance-paper/` | Complete collaborator-owned strategy, analysis, results, agent config, and paper monitors. |
