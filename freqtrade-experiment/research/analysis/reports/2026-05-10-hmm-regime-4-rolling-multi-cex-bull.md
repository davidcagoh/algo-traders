...
**Strategy file:** `strategies/HmmRegime4Rolling.py` (unchanged; no funding dependency)
...
Result archive: `analysis/backtests/hmm_multi_binance_bull_2023_2025.zip`
