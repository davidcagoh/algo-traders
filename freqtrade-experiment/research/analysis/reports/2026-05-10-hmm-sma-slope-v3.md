...
**Strategy file:** `strategies/HmmSmaSlopeV3.py`
...
- **DSR analysis flags V3 (and every other strategy) as NOISE.** Per `analysis/reports/2026-05-10-dsr-analysis.md`, V3's daily-wallet Sharpe is 1.15 but kurtosis 117 inflates the deflation threshold; per-trade Sharpe 1.36 still falls below SR_star 2.17.
