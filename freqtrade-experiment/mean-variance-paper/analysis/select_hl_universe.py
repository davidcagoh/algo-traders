...
Writes:
  analysis/results/universe_selection_hl_1h_current.json
  analysis/results/universe_selection_corr_current.png
  analysis/results/universe_selection_prices_current.png
"""
