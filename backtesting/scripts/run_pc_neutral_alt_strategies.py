...
Writes:
  wiki/results/pc_neutral_alt_strategies_hl_1h_current.json
  wiki/results/pc_neutral_alt_strategies_hl_1h_current.md
  wiki/assets/pc_neutral_alt_equity_top.png
  wiki/assets/pc_neutral_alt_scatter.png
  wiki/assets/pc_neutral_alt_cluster_bars.png
"""
...
DATA_DIR = REPO / "user_data" / "data" / "hyperliquid" / "futures"
RESULTS_DIR = REPO / "wiki" / "results"
ASSETS_DIR = REPO / "wiki" / "assets"
