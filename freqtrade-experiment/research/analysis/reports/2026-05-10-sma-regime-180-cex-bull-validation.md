...
**Strategy:** `strategies/SmaRegime180.py` (unchanged from 2026-04-30)
...
**Config:** `configs/config_binance.json` (futures swap, USDT stake, dry_run_wallet 10000)
...
./.venv/bin/freqtrade download-data \
  ...
  --datadir data --strategy-path strategies --data-format-ohlcv feather

# Full window
./.venv/bin/freqtrade backtesting \
  --datadir data --strategy-path strategies -c configs/config_binance.json \
