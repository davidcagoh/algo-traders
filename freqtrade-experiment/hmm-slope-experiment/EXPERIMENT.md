...
This is the original Hyperliquid crypto-perpetuals experiment, centered on the
`HmmSmaSlopeV2` candidate:
...
| Evaluation | `../../evaluation-framework/evaluation/`, `research/analysis/`, `../../wiki/` | Shared metrics, experiment adapters, reports, and cross-cutting records |
