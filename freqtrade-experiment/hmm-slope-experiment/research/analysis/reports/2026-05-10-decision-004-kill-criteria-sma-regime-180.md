...
**Related:** `learnings.md` open hypothesis #7 (regime carry-over inflation), `2026-04-24-decision-003-baseline-eval.md`, Davies & Ravagnani 2026 (continuous shrinkage framework)
