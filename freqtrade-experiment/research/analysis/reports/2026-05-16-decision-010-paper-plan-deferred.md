...
- `analysis/reports/correlation_matrix.png` — strategy correlation heatmap (will need serif re-render for publication)
- `analysis/reports/pareto.png` — 3-panel Pareto chart (Calmar/MDD, Martin/Ulcer, MDB/corr)
...
1. [x] Decision 009 (portfolio-aware K1) is written and applied. (2026-05-16: written; combined-book MDD_rp = 2.12% confirmed via `analysis/combined_book_mdd.py`.)
2. [x] Two-leg PairsZScore v2 ships and X1 is re-evaluated. (2026-05-16: shipped, X1 kill strengthened, framework limit recorded.)
3. [x] Binance funding parquets extended to 5.5y; C1 and F1 re-run on full window. ✅ 2026-05-16 — see `analysis/reports/2026-05-16-funding-{carry,extreme-mr}-fullwin.md`.
...
- The article series (`research/analysis/reports/` parallel to `feishu/wiki/course/`). This serves a different audience (blog / casual) and can be written independently when motivation strikes. Not on the critical path.

## Cross-references

- `2026-05-10-decision-004-kill-criteria-sma-regime-180.md` — original K1 definition
- `2026-05-16-decision-005-evaluation-and-diversity-plan.md` — pre-decisions and overall plan
- `2026-05-16-decision-006-kill-criteria-pairs.md` — pairs kill criteria (and the K1 = 8% precedent)
- `2026-05-16-decision-007-kill-criteria-cross-sectional.md`
- `2026-05-16-decision-008-kill-criteria-funding-mr.md`
- `../../../../wiki/concepts/correlation-and-mdb.md`
- `../../../../publications/evaluation-framework/worked-example.md` (the dense internal writeup that served as the prose substrate for the paper)
