...
The collaborator-owned signed mean-variance and PC-neutral work now lives
entirely in [`../../mean-variance-paper/`](../../mean-variance-paper/). It reuses this
project's ignored market-data cache and Freqtrade environment, but does not
share this project's strategy, results, execution, or monitoring ownership.
