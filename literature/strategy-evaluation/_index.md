...
| 2005 | Hansen, *A Test for Superior Predictive Ability* ([DOI](https://doi.org/10.1198/073500105000000063)) | Studentized bootstrap comparison of many alternatives against a benchmark. | **Record only: download TLS failure** |
| 2000 | White, *A Reality Check for Data Snooping* ([DOI](https://doi.org/10.1111/1468-0262.00152)) | Bootstrap test of whether the best model in a specification search beats a benchmark after data reuse. | **Record only: paywalled** |
