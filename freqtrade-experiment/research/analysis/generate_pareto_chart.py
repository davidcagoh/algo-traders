#!/usr/bin/env python3
"""
Generate analysis/reports/pareto.png — three-panel Pareto-frontier publication chart.
...
Data is sourced from A1.5 common-window backtests (`analysis/run_correlation_mdb.py` JSON
...
OUT_PATH = REPO_ROOT / "analysis" / "reports" / "pareto.png"
