...
**Strategy:** `strategies/HmmRegime4Rolling.py`
**Backtest ZIP:** `analysis/backtests/backtest-result-2026-05-10_01-41-03.zip`
...
**This is the cleanest evidence yet for the look-ahead alpha hypothesis** raised in `../learnings.md`. Open hypothesis #5 (HMM lifts win rate vs SmaRegime180's ~22%) holds with a smaller margin: 37.7% vs 21.9% is still +16pp, still real.
...
- Run on CEX BTC history (Binance perps, ~2019–) to get more bear/bull cycles for stability assessment. Use this as *training-set check*, not as Hyperliquid evaluation (per `../learnings.md` data-sourcing rule).
