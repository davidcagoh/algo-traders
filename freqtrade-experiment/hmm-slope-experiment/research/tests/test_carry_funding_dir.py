...
def test_default_routes_to_hyperliquid(monkeypatch, tmp_path, module_name):
    ...
    _write_funding(
        tmp_path / "data/hyperliquid/funding/BTC-funding.parquet", 0.0001
    )
    _write_funding(
        tmp_path / "data/binance/funding/BTC-funding.parquet", 0.0009
    )
